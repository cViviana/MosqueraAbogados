...
class valFormRegUser extends FormRequest
{
    ...
    {
        return [
            'cedula.digits_between' => 'La identificación del usuario debe estar entre 7 y 20 dígitos.',
            'nombre.max' => 'El nombre debe ser menor a 60 dígitos.',
            'telefono.digits_between' => 'El número de teléfono debe ser mayor a 7 dígitos y menor a 20 dígitos.',
