...
@section('seccion')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{route('cambioContrasenia')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-key fa-sm text-white-50"></i> Cambiar Contraseña</a>
    </div>
    <div class="row">
        <!-- Nombre perfil -->
